    ...
    public static Connection conectar() throws ClassNotFoundException {
        ...
        try {
            ...
            conexao = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/DIOme?useTimezone=true&serverTimezone=UTC",  // URL do banco de dados
                "root",  // Nome de usuário para acessar o banco
                "admin"    // Senha para acessar o banco
            );
